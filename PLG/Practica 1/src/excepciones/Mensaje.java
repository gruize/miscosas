...
public class Mensaje{
	...
	public String toString(){
		...
		{
			mensajeError="Error token inconrrecto en la l�nea: " +this.tokenErr.linea+ 
			"columna: "+this.tokenErr.columna+"/nSe esperaba: "+this.tokenOk;
		}
		else if(this.error==ERROR_ID_DUPLICADO)
		{
			mensajeError="Error: Identificador duplicado en la l�nea: " +this.tokenErr.linea+ 
			"columna: "+this.tokenErr.columna;
		}
		else if(this.error==ERROR_ID_PALABRA_RESERVADA)
		{
			mensajeError="Error: En palabra reservada en la l�nea: " +this.tokenErr.linea+ 
			"columna: "+this.tokenErr.columna;
		}
		else if(this.error==ERROR_FALTA_PUNTO_Y_COMA)
		{
			mensajeError="Error: Falta punto y coma en la l�nea: " +this.tokenErr.linea+ 
			"columna: "+this.tokenErr.columna;
		}
		else if(this.error==ERROR_TIPOS)
		{
			mensajeError="Error: De tipos en la l�nea: " +this.tokenErr.linea+ 
			"columna: "+this.tokenErr.columna;
		}
		else if(this.error==ERROR_N0_EXISTE_ID)
		{
			mensajeError="Error: No existe ID en la l�nea: " +this.tokenErr.linea+ 
			"columna: "+this.tokenErr.columna;
		}
		else if(this.error==ERROR_NO_MODIFICABLE)
		{
			mensajeError="Error: Es constate, no modificable en la l�nea: " +this.tokenErr.linea+ 
			"columna: "+this.tokenErr.columna;
		}
